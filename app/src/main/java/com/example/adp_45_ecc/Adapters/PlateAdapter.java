package com.example.adp_45_ecc.Adapters;
...
import com.example.adp_45_ecc.R;
...
public class PlateAdapter extends RecyclerView.Adapter<PlateAdapter.PlateViewHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull PlateAdapter.PlateViewHolder holder, int position) {
